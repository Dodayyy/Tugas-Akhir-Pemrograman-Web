            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="tampil_4tib.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                include("koneksi.php");
                $nim = $_GET['x'];
                $sql = "select * from tb_krs where nim='$nim'";
                ...
                <div class="card">
                    <div class="card-header card text-white" style="background-color: #15a362">
                        <h1 class="h4 mb-0 text-gray-100 text-white">Form Ubah Data KRS-B</h1>
                    </div>
                    <div class="card-body">
                        <form action="update_4tib.php" method="POST">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">NIM</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['nim']; ?>" name="nim" readonly>
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['nama']; ?>" name="nama">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['kd_mk']; ?>" name="kd_mk">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama Mata Kuliah</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['nm_mk']; ?>" name="nm_mk">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Jumlah SKS</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['jumlah_sks']; ?>" name="jumlah_sks">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Semester</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['semester']; ?>" name="semester">
                            </div>
