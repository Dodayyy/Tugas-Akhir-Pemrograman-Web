            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="mahasiswa_4tia.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Data Mahasiswa 4TI-A</h1>
                <!--//app-card-->

                <?php
                include("koneksi.php");
                $sql = "select * from mahasiswa WHERE kelas IN ('4TI-A')";
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-start align-items-center">
                            ...
                            <div class="col-auto">
                                <select class="form-select" onchange="window.location.href = this.value;">
                                    ...
                                    <option selected value="mahasiswa_4tia.php">4TI-A</option>
                                    <option value="mahasiswa_4tib.php">4TI-B</option>
                                    <option value="mahasiswa_4tic.php">4TI-C</option>
                                </select>
                            </div>
                        </div>
