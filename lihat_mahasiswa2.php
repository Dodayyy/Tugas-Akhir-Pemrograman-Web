                            ...
                            <tbody>
                                ...
                                while ($isi = mysqli_fetch_assoc($proses)) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" class="btn" style="background-color: #525FE1" href="registrasi.php?x=<?php echo $isi['kode_daftar'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-pencil-square" viewBox="0 0 16 16">
