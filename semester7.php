            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active " href="semester7.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Data Mata Kuliah Semester 7</h1>
                <!--//app-card-->
                <?php
                include("koneksi.php");
                $sql = "select * from mata_kuliah WHERE kode_matkul IN ('TIK701','TIK702','TIK703','TIK704','TIK705','TIK706','TIK707','TIK708','TIK709','TIK710',
                'TIK711','TIK712','TIK713','TIK714','TIK715','TIK716','TIK717','TIK718','TIK719','TIK720')";
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-start align-items-center">
                            ...
                            <div class="col-auto">
                                <select class="form-select" onchange="window.location.href = this.value;">
                                    ...
                                    <option selected value="semester7.php">Semester 7</option>
                                </select>
