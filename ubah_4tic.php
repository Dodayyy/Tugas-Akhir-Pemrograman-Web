            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link" href="tampil_mahasiswa.php">
                                <span class="nav-icon">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="tampil_4tic.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                include("koneksi.php");
                $id = $_GET['x'];
                $sql = "select * from 4tic where id_jadwal='$id'";
                ...
                <div class="card">
                    <div class="card-header card text-white" style="background-color: #15a362">
                        <h1 class="h4 mb-0 text-gray-100 text-white">Form Ubah Data Jadwal Kuliah 4TI-C</h1>
                    </div>
                    <div class="card-body">
                        <form action="update_4tic.php" method="POST">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">ID</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['id_jadwal']; ?>" name="id_jadwal" readonly>
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Hari</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['hari']; ?>" name="hari">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Jam</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['jam']; ?>" name="jam">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Mata Kuliah</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['matkul']; ?>" name="matkul">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Dosen Pengajar</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['pengajar']; ?>" name="pengajar">

                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Ruangan</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['ruangan']; ?>" name="ruangan">
                            </div>

                            <button type="submit" class="btn text-white" style="background-color: #15a362">Ubah</button>
                        </form>
                    </div>
                </div>
