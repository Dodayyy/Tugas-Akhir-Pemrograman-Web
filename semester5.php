            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active " href="semester5.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Data Mata Kuliah Semester 5</h1>
                <!--//app-card-->
                <?php
                include("koneksi.php");
                $sql = "select * from mata_kuliah WHERE kode_matkul IN ('TIK501','TIK502','TIK503','TIK504','TIK505','TIK506','TIK507','TIK508','TIK509','TIK510',
                'TIK511','TIK512','TIK513','TIK514','TIK515','TIK516','TIK517','TIK518','TIK519','TIK520')";
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-start align-items-center">
                            ...
                            <div class="col-auto">
                                <select class="form-select" onchange="window.location.href = this.value;">
                                    ...
                                    <option selected value="semester5.php">Semester 5</option>
