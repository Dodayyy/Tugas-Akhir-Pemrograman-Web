            ...
            <div class="container-xl">
                ...
                <div class="card">
                    <div class="card-header card text-white" style="background-color: #15a362">
                        <h1 class="h4 mb-0 text-gray-100 text-white">Form Tambah Data Mata Kuliah</h1>
                    </div>
                    <div class=" card-body">
                        <form action="simpan_matakuliah.php" method="POST">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Kode Mata Kuliah</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="kode_matkul">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="sks">
                            </div>
