            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active " href="semester1.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Data Mata Kuliah Semester 1</h1>
                <!--//app-card-->
                <?php
                include("koneksi.php");
                $sql = "select * from mata_kuliah WHERE kode_matkul IN ('TIK101','TIK102','TIK103','TIK104','TIK105','TIK106','TIK107','TIK108','TIK109','TIK110',
                'TIK111','TIK112','TIK113','TIK114','TIK115','TIK116','TIK117','TIK118','TIK119','TIK120')";
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-start align-items-center">
                            ...
                            <div class="col-auto">
                                <select class="form-select" onchange="window.location.href = this.value;">
                                    ...
                                    <option selected value="semester1.php">Semester 1</option>
