            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active" href="tampil_matakuliah.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                include("koneksi.php");
                $kode = $_GET['x'];
                $sql = "select * from mata_kuliah where kode_matkul='$kode'";
                ...
                <div class="card">
                    <div class="card-header card text-white" style="background-color: #15a362">
                        <h1 class="h4 mb-0 text-gray-100 text-white">Form Ubah Data Mata Kuliah</h1>
                    </div>
                    <div class="card-body">
                        <form action="update_matakuliah.php" method="POST">
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Kode Mata Kuliah</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['kode_matkul']; ?>" name="kode_matkul" readonly>
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Nama Mata Kuliah</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['nama_matkul']; ?>" name="nama_matkul">
                            </div>

                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">SKS</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $isi['sks']; ?>" name="sks">

                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Deskripsi</label>
                                    <select class="form-select" aria-label="Default select example" name="deskripsi">
                                        <option value="<?php echo $isi['deskripsi']; ?>"><?php echo $isi['deskripsi']; ?></option>
