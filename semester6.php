            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        ...
                        <li class="nav-item">
                            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
                            <a class="nav-link active " href="semester6.php">
                                <span class="nav-icon">
    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Data Mata Kuliah Semester 6</h1>
                <!--//app-card-->
                <?php
                include("koneksi.php");
                $sql = "select * from mata_kuliah WHERE kode_matkul IN ('TIK601','TIK602','TIK603','TIK604','TIK605','TIK606','TIK607','TIK608','TIK609','TIK610',
                'TIK611','TIK612','TIK613','TIK614','TIK615','TIK616','TIK617','TIK618','TIK619','TIK620')";
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-start align-items-center">
                            ...
                            <div class="col-auto">
                                <select class="form-select" onchange="window.location.href = this.value;">
                                    ...
                                    <option selected value="semester6.php">Semester 6</option>
