    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                <h1 class="app-page-title">Data Jadwal Kuliah 4TI-C</h1>
                <!--//app-card-->

                <?php
                include("koneksi.php");
                $sql = "select * from 4tic";
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-start align-items-center">
                            <div class="col-auto">
                                <a type="button" class="btn text-white" style="background-color: #15a362" href="tambah_4tic.php">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
                                        <path d="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z" />
                                        <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z" />
                                    </svg>
                                    Tambah Jadwal Kuliah</a>
                            </div>
                            <div class="col-auto">
                                <select class="form-select" onchange="window.location.href = this.value;">
                                    <option selected value="tampil_4tic.php">4TI-C</option>
                                    <option value="tampil_4tia.php">4TI-A</option>
                                    <option value="tampil_4tib.php">4TI-B</option>
                                </select>
                        ...
                        <table class="table table-bordered" id="dataTable">
                            ...
                            <tbody>
                                ...
                                while ($isi = mysqli_fetch_assoc($proses)) : ?>
                                    <tr>
                                        <td><?php echo $isi['id_jadwal']; ?></td>
                                        <td><?php echo $isi['hari']; ?></td>
                                        <td><?php echo $isi['jam']; ?></td>
                                        <td><?php echo $isi['matkul']; ?></td>
                                        <td><?php echo $isi['pengajar']; ?></td>
                                        <td><?php echo $isi['ruangan']; ?></td>
                                        <td>
                                            <a type="button" class="btn" style="background-color: #525FE1" href="ubah_4tic.php?x=<?php echo $isi['id_jadwal'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z" />
                                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z" />
                                                </svg></a>
                                            <a type="button" class="btn" style="background-color: #F86F03" href="hapus_4tic.php?x=<?php echo $isi['id_jadwal']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-trash3-fill" viewBox="0 0 16 16">
